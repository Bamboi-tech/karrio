...
export default function GraphiQLUI() {
  ...
  const fetcher = React.useMemo(() => {
    ...
    return createGraphiQLFetcher({
      ...
      headers: {
        ...
        ...(session?.testMode
          ? { "x-test-mode": session.testMode.toString() }
          : {}),
        ...(session?.accessToken
      ...
      mutations.forEach((mutation) => {
        mutation.addedNodes.forEach((node) => {
          if (node.nodeType === Node.ELEMENT_NODE) {
            ...
            if (
              element.classList.contains("graphiql-dialog-overlay") ||
    ...
    <div className="h-full w-full overflow-hidden">
      <div className="h-full relative">
        <style jsx global>{`
          ...
          .devtools-theme.dark .graphiql-container {
          ...
          .devtools-theme.dark .graphiql-doc-explorer {
            background: hsl(var(--card)) !important;
          }
          .devtools-theme.dark .graphiql-toolbar button,
          .devtools-theme.dark .graphiql-toolbar select,
          .devtools-theme.dark .graphiql-toolbar input {
            color: hsl(var(--foreground)) !important;
            border-color: hsl(var(--border)) !important;
            background: hsl(var(--input)) !important;
          }
          .devtools-theme.dark .graphiql-dialog {
            background: hsl(var(--popover)) !important;
            color: hsl(var(--popover-foreground)) !important;
          }

          /* Toolbar layout and sizing */
          .devtools-theme.dark .graphiql-toolbar {
            display: flex !important;
            flex-wrap: nowrap !important;
            gap: 8px !important;
            align-items: center !important;
          }
          .devtools-theme.dark .graphiql-execute {
            display: flex !important;
            align-items: center !important;
          }
          .devtools-theme.dark .graphiql-toolbar button,
          .devtools-theme.dark .graphiql-execute button {
            height: 40px !important;
            padding: 0 12px !important;
            border-radius: 8px !important;
            font-size: 15px !important;
          }
          .devtools-theme.dark .graphiql-toolbar button svg {
          ...
          .devtools-theme.dark .graphiql-execute button svg {
          ...
          .devtools-theme.dark .graphiql-editor .CodeMirror-cursor {
        ...
        `}</style>
        <div
          className="h-full w-full overflow-x-auto lg:overflow-x-hidden"
          style={{
